...
public class FunctionsInitializer {
    public static void initialize() {
        ...
        Functions.FUNCTIONS.get(0).realize(new FunctionCompare());
        ...
        Functions.FUNCTIONS.get(1).realize(new FunctionCreateUnion());
        ...
        Functions.FUNCTIONS.get(2).realize(new FunctionDeleteUnion());
        ...
        Functions.FUNCTIONS.get(3).realize(new FunctionDetail());
        ...
        Functions.FUNCTIONS.get(4).realize(new FunctionShow());
    }
}
